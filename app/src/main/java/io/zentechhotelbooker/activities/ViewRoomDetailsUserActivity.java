...
public class ViewRoomDetailsUserActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_room_details_user);
    ...
    public void seeMoreRoomsBtn(View view) {
        ...
        startActivity(new Intent(ViewRoomDetailsUserActivity.this, HomeActivity.class));
        CustomIntent.customType(ViewRoomDetailsUserActivity.this,"right-to-left");
        // finish the activity
        finish();
    }
