...
import io.zentechhotelbooker.adapters.RecyclerViewAdapterManageRooms;
import io.zentechhotelbooker.models.Admin;
import io.zentechhotelbooker.models.Rooms;
import maes.tech.intentanim.CustomIntent;

public class ManageRoomsActivity extends AppCompatActivity implements RecyclerViewAdapterManageRooms.onItemClickListener {
    ...
    RecyclerViewAdapterManageRooms recyclerViewAdapterManageRooms;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSupportActionBar() != null){
            getSupportActionBar().setTitle(getString(R.string.manage_rooms));
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(ManageRoomsActivity.this,2));

        roomsList = new ArrayList<>();

        // Creating an object of the RecyclerAdapter to populate the rooms
        recyclerViewAdapterManageRooms = new RecyclerViewAdapterManageRooms(ManageRoomsActivity.this,roomsList);

        recyclerView.setAdapter(recyclerViewAdapterManageRooms);

        recyclerViewAdapterManageRooms.setOnItemClickListener(ManageRoomsActivity.this);
    ...
    private void loadUploadedRoomDetails(){
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    recyclerViewAdapterManageRooms.notifyDataSetChanged();
    ...
    private void searchForRoom(String s){
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(ManageRoomsActivity.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case android.R.id.home:
                ...
                startActivity(new Intent(ManageRoomsActivity.this,AdminDashBoardActivity.class));

                // Adds a bottom-to-up animations to the activity
                CustomIntent.customType(ManageRoomsActivity.this,"fadein-to-fadeout");
    ...
    public void onBackPressed() {
        ...
        if(searchView.isSearchOpen()){
            ...
            // Adds a bottom-to-up animations to the activity
            CustomIntent.customType(ManageRoomsActivity.this,"up-to-bottom");
    ...
    public void onItemClick(int position) {
        Toast.makeText(ManageRoomsActivity.this," long click on a room to view options ",Toast.LENGTH_LONG).show();
    }
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                            ...
                            SharedPreferences preferences =
                                    PreferenceManager.getDefaultSharedPreferences(ManageRoomsActivity.this);
                            ...
                            if(password.equals(decryptedPassword) && adminEmail.equals(email)){
                                ...
                                roomImageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(ManageRoomsActivity.this, " Room deleted Successfully ", Toast.LENGTH_LONG).show();
                                    }
                                });
                                ...
                                Toast.makeText(ManageRoomsActivity.this,"Incorrect password. Please Try Again!",Toast.LENGTH_LONG).show();
                            }
